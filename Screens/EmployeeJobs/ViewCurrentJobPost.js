...
const ViewCurrentJobPost = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await fetch(`${API_URL}/user-current-job-details/${gid}`, {
                headers: {
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: "#222222" }}>
                <View style={styles.container}>
                    ...
                    >
                        <View style={styles.statsRow}>
                            <View style={styles.statsBox}>
                                ...
                                <Text style={styles.statsValue}>{job.gigProp?.prop_hourly_rate} CAD</Text>
                            </View>
                            <View style={styles.vertDivider} />
                            <View style={styles.statsBox}>
                                <Text style={styles.statsLabel}>Total Hour</Text>
                                <Text style={styles.statsValue}>{job.gigProp?.prop_total_hour}</Text>
                            </View>
                            <View style={styles.vertDivider} />
                            <View style={styles.statsBox}>
                                <Text style={styles.statsLabel}>Total Earn</Text>
                                <Text style={styles.statsValue}>{job.gigProp?.bid_price} CAD</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.section}>
                            ...
                            <Text style={styles.descriptionText}>{job.details?.description}</Text>
                        </View>
                    </ScrollView>
                    <View style={styles.btnRow}>
                        ...
                        <TouchableOpacity
                            style={styles.payBtn}
                            onPress={() => navigation.navigate("CurrentJobPaymentPage", { gid: job.details?.gid })}
                        >
