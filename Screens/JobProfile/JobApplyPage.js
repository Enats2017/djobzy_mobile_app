...
const JobApplyPage = () => {
  ...
  const { gid, subject, hour_minimum, fixed_minimum, expected_hour } =
    route?.params || {};
  ...
  return (
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.row}>
        <View style={styles.box}>
          ...
          <View style={styles.valueBox}>
            ...
            <Text style={styles.value}>{fixed_minimum}</Text>
          </View>
        </View>
        ...
        <View style={styles.box}>
          ...
          <View style={styles.valueBox}>
            <Text style={styles.currency}>CAD</Text>
            <View style={styles.divider} />
            <Text style={styles.value}>{hour_minimum}</Text>
          </View>
        </View>
      </View>

      <Text style={styles.note}>
        <Text style={styles.bold}>{expected_hour} Hours </Text>
      ...
      <View style={styles.offerHeader}>
        ...
        <FontAwesome name="question-circle" size={15} color="#c3c3c3c3"  style={{marginTop:2}}/>
      </View>
      ...
      {/* Introduction Letter */}
      <Text style={styles.sectionTitle}>Introduction Letter (Required)</Text>
      <TextInput
      ...
      >
        <View style={[styles.checkbox, agree && styles.checkedBox]}>
          {agree && <MaterialIcons name="check" size={18} color="#ffffff" />}
        </View>
        <Text style={styles.agreeText}>
          I agree to abide by the{" "}
          <Text style={styles.link}>Terms and Conditions</Text> of DJobzy.com
        </Text>
      </TouchableOpacity>

      {/* Send Button */}
      <TouchableOpacity
        style={[styles.sendButton, submitting && { backgroundColor: "#ccc" }]}
