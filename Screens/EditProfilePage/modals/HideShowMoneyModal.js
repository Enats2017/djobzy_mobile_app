...
// type = "hide" | "show"
const HideShowMoneyModal = ({ visible, onClose, type, onConfirm, loading }) => {
            ...
            <View style={styles.overlay}>
                <View style={[styles.container, { paddingBottom: insets.bottom}]}>
                    ...
                    <Text style={styles.title}>
                        {isHide ? "Hide Money?" : "Show Money?"}
                    </Text>

                    {/* Message */}
                    <Text style={styles.message}>
                        {isHide
                            ? "Are you sure you want to hide? It will not be visible to others."
                            : "Are you sure you want to show? It will be visible to others."}
                    </Text>
...
export default HideShowMoneyModal;
