...
const PostJobDetails = () => {
  ...
  const fetchUserAppliedDetials = async (id) => {
    try {
      ...
      console.log(id);
      const token = await AsyncStorage.getItem("token");
      const response = await fetch(`${API_URL}/view-profile/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          Accept: "application/json",
        },
              ...
              <View style={styles.pricingContainer}>
                ...
                <Text style={styles.pricingInfo}>
                  ...
                  <Text style={styles.pricingHighlight}>
                    CAD {postJob.details?.bid_price}
                  </Text>
                  {"  "}
                  Hourly Rate:{" "}
                  <Text style={styles.pricingHighlight}>
                    CAD {postJob.details?.prop_hourly_rate}
                  </Text>
                </Text>
              ...
              <View style={styles.payHireModalCard}>
                ...
                <View style={styles.payHireModalRow}>
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.payHireModalValue}>
                      CAD {profileData?.bid_price}
                    </Text>
                  </View>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.payHireModalValue}>
                      CAD {profileData?.prop_hourly_rate}
                    </Text>
                  </View>
                </View>
                <Text>
                  <Text style={styles.payHireModalRedText}>
                    {profileData?.expected_hour} Hours
                  </Text>
                ...
                <Text style={styles.payHireModalAgreement}>
                  By hiring this employee I agree to the Djobzy Terms and
                  Conditions and Policies and that I have given enough time to
                  read it and understand that it contains important information
                  about my use of Djobzy, like limiting liability and my
                  agreement on how disputes between me and Djobzy will be
                  handled
                </Text>
...
const styles = StyleSheet.create({
  ...
  deActivateModalSecondaryBtnText: {
    color: "#000000",
    fontFamily: "Montserrat_700Bold",
    fontSize: 16,
  },
